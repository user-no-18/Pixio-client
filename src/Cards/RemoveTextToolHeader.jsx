...
const RemoveText = () => {
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div>
              <h1 className="text-5xl lg:text-7xl font-black tracking-tighter leading-tight">
                Remove Text <span className="text-blue-500">AI.</span>
              </h1>
              ...
              <div className="mt-12 relative group inline-block">
                ...
                <div className="relative p-[1.5px] overflow-hidden rounded-full bg-white/10 group-hover:bg-transparent transition-colors duration-500">
                  ...
                  <button
                    onClick={() =>
                      user ? navigate("/remove-text") : setShowLogin(true)
                    }
        ...
        <section className="px-6 pb-32 max-w-7xl mx-auto border-t border-white/5 pt-24">
          <div className="text-center mb-20">
            ...
            <p className="text-white/40 text-lg max-w-2xl mx-auto">
              Professional-grade text removal in three simple steps
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Upload an image containing text, captions, watermarks, or typography that you want to remove.",
                gradient: "from-blue-600/5 to-transparent",
              },
              {
                step: "02",
                title: "Intelligent removal",
                desc: "The AI identifies text regions automatically and removes detected text while the surrounding background is reconstructed seamlessly for a natural result.",
                gradient: "from-purple-600/5 to-transparent",
              },
              {
                step: "03",
                title: "Download image",
                desc: "Download the final image in high resolution, ready for professional use.",
 ...
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3 group">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/10 p-6">
                <p className="text-white/70 leading-relaxed">
                  • Cleaning captions or subtitles<br/>
                  • Removing text overlays from photos<br/>
                  • Preparing images for reuse or redesign
                </p>
              </div>
            </div>
            <div className="space-y-3 group">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-blue-500/30 shadow-xl shadow-blue-500/10 p-6">
                <p className="text-white/70 leading-relaxed">
                  • Enhancing visual clarity for marketing assets
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-28 flex flex-col md:flex-row items-center justify-center gap-6">
            <button
              onClick={() => (user ? navigate("/remove-text") : setShowLogin(true))}
