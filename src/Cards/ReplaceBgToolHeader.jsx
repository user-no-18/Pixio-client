          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div>
              <h1 className="text-5xl lg:text-7xl font-black tracking-tighter leading-tight">
                Replace Background <span className="text-blue-500">AI.</span>
              </h1>
              ...
              <div className="mt-12 relative group inline-block">
                ...
                <div className="relative p-[1.5px] overflow-hidden rounded-full bg-white/10 group-hover:bg-transparent transition-colors duration-500">
                  ...
                  <button
                    onClick={() =>
                      user ? navigate("/replace-bg") : setShowLogin(true)
                    }
        ...
        <section className="px-6 pb-32 max-w-7xl mx-auto border-t border-white/5 pt-24">
          <div className="text-center mb-20">
            ...
            <p className="text-white/40 text-lg max-w-2xl mx-auto">
              Professional-grade background replacement in three simple steps
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Upload an image containing a clear subject. The AI automatically separates the foreground from the background.",
                gradient: "from-blue-600/5 to-transparent",
              },
              {
                step: "02",
                title: "AI background generation",
                desc: "Enter a text prompt describing the desired background scene. The AI generates a new background that matches lighting, perspective, and composition of the original image.",
                gradient: "from-purple-600/5 to-transparent",
              },
              {
                step: "03",
                title: "Download final image",
                desc: "Export the final image in high resolution, ready for marketing, design, or creative workflows.",
            ...
            <div className="space-y-3 group">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/10 p-6">
                <p className="text-white/70 leading-relaxed">
                  • Creating studio-quality backgrounds for portraits
                </p>
              </div>
            </div>
            <div className="space-y-3 group">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/10 p-6">
                <p className="text-white/70 leading-relaxed">
                  • Product photography background replacement<br/>
                  • Generating creative scenes for marketing visuals<br/>
                  • Social media and advertising content creation
                </p>
              </div>
            </div>
            <div className="space-y-3 group">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-blue-500/30 shadow-xl shadow-blue-500/10 p-6">
                <p className="text-white/70 leading-relaxed">
                  • Visual storytelling and concept design
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-28 flex flex-col md:flex-row items-center justify-center gap-6">
            <button
              onClick={() => (user ? navigate("/replace-bg") : setShowLogin(true))}
